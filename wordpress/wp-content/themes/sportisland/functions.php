<?php
    ...
    function si_register_types() {
        ...
        register_post_type( 'orders', [
            'labels' => [
                ...
                'add_new'            => 'Добавить новые заявки', // для добавления новой записи
                'add_new_item'       => 'Добавить новые заявки', // заголовка у вновь создаваемой записи в админ-панели.
    ...
    function si_likes_column($col_name, $id) {
