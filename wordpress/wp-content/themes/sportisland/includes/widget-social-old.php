...
class SI_Widget_Social_old extends WP_Widget {

    public function __construct(){
        parent::__construct(
            'si_widget_social_old',
            'SportIsland - виджет социальных сетей',
            [
                'name' => 'SportIsland - виджет социальных сетей',
                'description' => 'Выводит соц кнопки и их ссылки'
            ]
        );
    }
...
?>
        ...
        <p>
            ...
            <?php foreach ($this->socials as $slug => $desc ) : ?>
                <option
                    value=" <?php var_dump($this->socials[$slug][1]);echo $slug; ?> "
